...
#![allow(unused_parens)]
use rust_arango::{connection::Connection, Collection, Database};
...
pub async fn connection() -> rust_arango::Connection {
...
#[maybe_async::maybe_async]
pub async fn collection(conn: &rust_arango::Connection, name: &str) -> Collection {
